   ...
   private Dialog saveDialogs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            web.checkVersioneTabletAndUpdate(getMacAddr(),String.valueOf(ver),(Integer done)->{
                String msg;
                if(done==0) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == ID_RICHIESTA_PERMISSION_LOCALIZZAZIONE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                web.checkScarico(getMacAddr(),(Boolean response)->{
                    web.insertLog(getMacAddr(), 0, menuPrincipaleActivity.class .getName(),"Sono in checkScarico per InstallaNuovaVersione(null) response -> " + String.valueOf(response),"", (Integer done)->{
                        if(done==-1) {
                ...
                //} else {
                    ...
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(this);
                    builder2.setMessage("L'applicazione non è stata aggiornata e non verrà avviata, abilitare nel tablet il salvataggio e l'avvio dell'installazione di una nuova versione.")
...
/*
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!=PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,  Manifest.permission.READ_EXTERNAL_STORAGE}, SCRIVI_DOWNLOAD);
            return;
        }
 ...
 */
      ...
      /*  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M  &&
            ...
            tmpDlg = dlg;
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.REQUEST_INSTALL_PACKAGES}, INSTALLA_PACCHETTI);
            return;
        }*/
        ...
        String fileName = "TLCustomerApp.apk";
        ...
        TLFidelityWS web = new TLFidelityWS(this);
        final AlertDialog finalDlg = dlg;
            ...
            if (downloaded && file.exists()) {
                ...
                try{
                    Uri apkURI = FileProvider.getUriForFile( menuPrincipaleActivity.this,
                            menuPrincipaleActivity.this.getApplicationContext().getPackageName() + ".provider", file);
    ...
    private void ControllaApp(TLFidelityWS web, AlertDialog  dlg) {
        ...
        //TODO: inserisco/aggiorno la versione nella tabella Anag_AutorizzazioniTablet se non presente
...
/**
        web.checkVersioneAndUpdate(ver,(Boolean chiudi)-> {
            if(chiudi) {
                //TODO: controllo che il tablet abbia l'autorizzazione allo scarico altrimenti ignoro
                web.checkScarico(getMacAddr(), (Boolean response)-> {
                    if (response) {
 ...
 */
        web.autorizzazioneScarico(getMacAddr(), String.valueOf(ver),(Boolean response)-> {
