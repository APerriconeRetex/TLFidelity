    ...
    static String getBaseUrl() {
        if(baseUrl==null) {
            if(BuildConfig.DEBUG)
                ...
                baseUrl = "http://fidelityibba.abbiholding.com/TLFidelityWS_Cartissima";
        }
        return baseUrl;
    }
 ...
 */
    ...
    static class scaricaNuovaVersione extends AsyncTask<String,Integer,Boolean> {
        AsyncCallback<Boolean> onDone;
        AsyncCallback<Integer[]> onProgress;
        @SafeVarargs
        final void execute(AsyncCallback<Boolean> onDone,AsyncCallback<Integer[]> onProgress, String... params) {
            this.onDone=onDone;
        ...
        @Override
        protected Boolean doInBackground(String... destPath) {
            ...
            try {
               ...
               // conn = GetConnection("/api/app/apk/release43");
                ...
                FileOutputStream outputStream = new FileOutputStream(destPath[0]);
    ...
    void scaricaNuovaVersione(String destPath, AsyncCallback<Boolean> onDone,AsyncCallback<Integer[]> onProgress) {
        new scaricaNuovaVersione().execute(onDone,onProgress, destPath);
    }

    static class checkVersioneTabletAndUpdate extends MyCaller<String,Integer> {

        @Override
        protected String getPage(String @NotNull ... strings) {
    ...
    static class emailCliente extends MyCaller<String, Void> {
        ...
        protected Void EvaluateConnection(HttpURLConnection conn) throws Exception {
            ...
            String jsonEmail="{\n" +
                    "  \"From\": {\n" +
                    "    \"name\": \"La Cartissima\",\n" +
                    "    \"address\": \"lacartissima@abbiholding.com\"\n" +
                    "  },\n" +
                    "  \"To\": [{\n" +
                    "      \"name\": \""+cliente+"\",\n" +
                    "      \"address\": \""+email+"\"\n" +
    ...
    static class changeType extends MyCaller<String,Boolean> {

        @Override
        protected String getPage(String... strings) {
            return "/api/Tessere/changeType/"+strings[0]+"/"+strings[1];
    ...
    void changeType(String tessera, Boolean isSenior, AsyncCallback<Boolean> onDone) {
        new changeType().execute(onDone,tessera, isSenior.toString());
    }
