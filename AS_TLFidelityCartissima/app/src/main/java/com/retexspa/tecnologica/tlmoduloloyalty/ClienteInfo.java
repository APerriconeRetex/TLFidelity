...
public class ClienteInfo {
    ...
    void FromForm(String json) throws JSONException {
        ...
        for (int i = 0; i < parsed.length(); i++) {
            ...
            switch (curr.getString("name")) {
                ...
                case "PIVA": PIVA = curr.getString("value"); break;
    ...
    public String tojQuery() {
        ...
        dest.append("\"PIVA\": \"").append(PIVA).append("\", ");
        ...
        dest.append("\"cartaSenior\": \"").append(cartaSenior).append("\", ");
