...
public class ClienteInfo {
    ...
    public String stato;
    public boolean animaliC; //S o N
    public boolean animaliG; //S o N
    ...
    void FromForm(String json) throws JSONException {
        ...
        for (int i = 0; i < parsed.length(); i++) {
            ...
            switch (curr.getString("name")) {
                ...
                case "professione": professione = curr.getString("value"); break;
                case "studio": studio = curr.getString("value"); break;
                case "telfisso": telFisso = curr.getString("value"); break;
                case "stato": stato = curr.getString("value"); break;
                case "animaliC": animaliC = curr.getBoolean("value"); break;
                case "animaliG": animaliG = curr.getBoolean("value"); break;
            }
        }
    ...
    void FromWS(String json) throws JSONException {
        ...
        animaliC  = parsed.getBoolean("animaliC");
        animaliG  = parsed.getBoolean("animaliG");
        professione  = parsed.getString("professione");
        studio  = parsed.getString("studio");
        telFisso = parsed.getString("telfisso");
        stato = parsed.getString("stato");
    ...
    public String tojQuery() {
        ...
        dest.append("\"tessera\": \"").append(codiceTessera).append("\", ");
        dest.append("\"dataFirma\": \"").append(dataFirma).append("\", ");
        dest.append("\"professione\": \"").append(professione).append("\", ");
        dest.append("\"studio\": \"").append(studio).append("\", ");
        dest.append("\"telfisso\": \"").append(telFisso).append("\", ");
        dest.append("\"stato\": \"").append(stato).append("\", ");
        dest.append("\"codiceTessera\": \"").append(codiceTessera).append("\", ");
        dest.append("\"animaliC\": \"").append(animaliC).append("\", ");
        dest.append("\"animaliG\": \"").append(animaliG).append("\"} ");
